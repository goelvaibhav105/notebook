...
const NoteState = (props)=>{
    const notesInitial = [
      ...
      const addNote = (title, description, tag)=>{
        ...
        // see only 3 items are variable as other items are selfgenrating in our API 
        const note = {
          "_id": "61322f119553781a8ca8d0e08",
    ...
    return (
      // here in value we are only passing states which we can use in our note application anywhere 
